...
class __TwigTemplate_8a60fe87601950586c9eaa4c5af0bfbdc4e992528302b47c9311c6a8ecce15e2 extends Twig_Template
{
    ...
    public function getpagination($__pagination__ = null, $__url__ = null, $__ps__ = null, $__appendUrl__ = null, ...$__varargs__)
    {
      ...
      <div class=\"admin-addon-user-manager-pagination__text\">Showing ";
                // line 28
                echo twig_escape_filter($this->env, ($this->getAttribute(($context["pagination"] ?? null), "startOffset", array()) + 1), "html", null, true);
                echo " - ";
                echo twig_escape_filter($this->env, $this->getAttribute(($context["pagination"] ?? null), "endOffset", array()), "html", null, true);
                echo " of ";
  ...
  {% endif %}
{% endmacro %}", "user-manager-macros.html.twig", "/Applications/MAMP/htdocs/VN/grav/user/plugins/admin-addon-user-manager/templates/user-manager-macros.html.twig");
    }
}
