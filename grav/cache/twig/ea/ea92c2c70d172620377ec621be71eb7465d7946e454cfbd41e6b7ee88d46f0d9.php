...
class __TwigTemplate_4a5e7f153e74cbc1027f04cde827ffa8687ec12ce30bef2710c257cb73a19d44 extends Twig_Template
{
          ...
          ";
            ...
            <div class=\"user\">
              ...
              <div class=\"user__actions\">
                ...
                <a href=\"";
                // line 76
                echo twig_escape_filter($this->env, $this->getAttribute(($context["uri"] ?? null), "addNonce", array(0 => (((((($context["base_url"] ?? null) . "/user/") . $this->getAttribute($context["user"], "username", array())) . "/task") . ($context["ps"] ?? null)) . "userDelete"), 1 => "admin-form", 2 => "admin-nonce"), "method"), "html", null, true);
...
{% endblock %}
", "user-manager.html.twig", "/Applications/MAMP/htdocs/VN/grav/user/plugins/admin-addon-user-manager/templates/user-manager.html.twig");
    }
}
